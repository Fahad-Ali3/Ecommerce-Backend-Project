...
import com.momsdeli.backend.security.CustomUserDetail;
import com.momsdeli.backend.security.JwtAuthFilter;
import com.momsdeli.backend.security.JwtEntryPoint;
...
@EnableWebSecurity
@EnableWebMvc
@EnableGlobalMethodSecurity(securedEnabled = true)// Use @EnableMethodSecurity instead of @EnableGlobalMethodSecurity
